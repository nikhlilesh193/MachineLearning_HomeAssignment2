...
Name: Nikhilesh Katakam #700772365
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
. printing accuracy, precision, recall, F1 via classification_report, and

. plotting one-vs-rest ROC curves with per-class AUC, plus micro and macro AUC.
